...
* C. Freer, `cameronfreer/graphon` at commit
  ...
  `Graphon/InfiniteExchangeability.lean`, a prior formalization of the same equivalence between
  consistent marginals and exchangeable laws on infinite graphs.
-/
