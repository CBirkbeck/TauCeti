...
theorem ratFuncAdjoinRange_eq_map (g : RatFunc K) :
    ratFuncAdjoinRange W g =
      (IntermediateField.adjoin K {g}).map
...
theorem mem_ratFuncAdjoinRange {g : RatFunc K} {z : W.FunctionField} :
    z ∈ ratFuncAdjoinRange W g ↔
      ∃ r ∈ IntermediateField.adjoin K {g},
...
theorem finrank_ratFuncAdjoinRange (g : RatFunc K) :
  ...
  have htower := relfinrank_mul_finrank_top (ratFuncAdjoinRange_le_ratFuncRange W g)
  rw [relfinrank_ratFuncAdjoinRange W g, finrank_ratFuncRange W] at htower
