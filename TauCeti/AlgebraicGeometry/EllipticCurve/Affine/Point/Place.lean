...
* `TauCeti.WeierstrassCurve.Affine.CoordinateRing.pointPlace`: the place — the height-one prime of
  the coordinate ring — attached to a solution of the Weierstrass equation.

## Main results

* `TauCeti.WeierstrassCurve.Affine.CoordinateRing.pointPlace_asIdeal`: its underlying ideal is
