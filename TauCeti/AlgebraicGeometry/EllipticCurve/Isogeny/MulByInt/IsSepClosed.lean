...
-- The points of `W` are those of its base change along the identity, the group the counts above
-- are stated on.
private noncomputable def pointEquivBaseChangeSelf : W.Point ≃+ (W⁄F).toAffine.Point :=
