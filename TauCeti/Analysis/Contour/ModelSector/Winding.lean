...
* `indexIntegral_arc_interval` — the normalized index integral of the arc over an arbitrary
...
The `indexIntegral_arc`, `windingNumber_at_i`, `windingNumber_at_rho`, and
