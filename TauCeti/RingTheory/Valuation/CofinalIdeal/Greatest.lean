...
theorem lt_one_of_not_idealMeetsCharacteristicSubgroup {v : Valuation A Γ₀} {I : Ideal A}
  ...
  exact hdisj ⟨a, haI, ha0, valueGroup_mk_mem_characteristicSubgroup_of_one_le_apply ha0 hge⟩
...
theorem idealMeetsCharacteristicSubgroup_of_one_le {v : Valuation A Γ₀} {I : Ideal A} {a : A}
  ...
  exact ⟨a, haI, h0, valueGroup_mk_mem_characteristicSubgroup_of_one_le_apply h0 ha⟩
