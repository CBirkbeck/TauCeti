...
/-- The class of the prime `v`, as an invertible fractional ideal, is `v.classGroupMk`. -/
private lemma classGroupMk_unitOfPrime (v : HeightOneSpectrum R) :
    ClassGroup.mk K (unitOfPrime K v) = v.classGroupMk := by
  rw [unitOfPrime, v.classGroupMk_eq_mk K]
...
lemma _root_.ClassGroup.mk_mem_closure_of_count_eq_zero {T : Set (HeightOneSpectrum R)}
  ...
  rw [map_zpow, classGroupMk_unitOfPrime]
