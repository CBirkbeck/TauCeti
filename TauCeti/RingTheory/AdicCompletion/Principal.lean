...
`4c04933eb7b686b01031d775541533c492131be6`, branch `announce/sheafy-not-stably-uniform`,
`projects/AdicSpaces/Adic spaces/FJP/AdicCompletionPrincipal.lean`. Adapted to the module
system; the mathematics is unchanged.
-/
