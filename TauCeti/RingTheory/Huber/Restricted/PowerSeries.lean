...
Of these, neither `isRestricted_pi_iff`, `restrictedMvPowerSeriesSubmodulePiEquiv` nor
`restrictedMvPowerSeriesSubringLinearEquiv` has an AINTLIB counterpart, for two different
reasons. The two product
