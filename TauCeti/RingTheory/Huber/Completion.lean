...
ideal of definition. -/
@[expose] noncomputable def completion (P : PairOfDefinition A) :
...
/-- The ideal of definition of the completed pair is `I · Â₀`. -/
@[simp]
theorem completion_ideal (P : PairOfDefinition A) :
    P.completion.idealOfDefinition = P.completionIdeal := (rfl)
