...
theorem range_fromFreeGroup (X : Type u) :
  ...
  conv_lhs => rw [← FreeGroup.lift.apply_symm_apply (fromFreeGroup X)]
  exact FreeGroup.range_lift_eq_closure
...
theorem dense_closure_range_of (X : Type u) :
  ...
  rw [← range_fromFreeGroup, MonoidHom.coe_range, coe_fromFreeGroup]
