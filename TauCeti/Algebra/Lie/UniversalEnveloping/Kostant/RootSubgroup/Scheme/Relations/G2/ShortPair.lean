...
This is the represented scheme-point form of
`kostantRootSubgroupPoints_mul_of_g2_short_pair`. It supplies the same relation inside
the closed group scheme generated by the root subgroups.
...
/-- The G₂ short-pair product relation on represented scheme points, with the three output
...
theorem schemePointsMulEquiv_kostantRootSubgroup_mul_of_g2_short_pair'
  ...
  schemePointsMulEquiv_kostantRootSubgroup_mul_of_g2_short_pair
    e h ρ M hM basis A hij hik hkj hil him hjm hkl hkm hlm hi hj hk hl hm f g _ _ _
