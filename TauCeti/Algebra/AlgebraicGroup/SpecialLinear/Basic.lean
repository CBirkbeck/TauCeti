...
[Reviews and tests of this file](https://cbirkbeck.github.io/tauceti-reviewed-by-test/#m=TauCeti.Algebra.AlgebraicGroup.SpecialLinear.Basic)
...
theorem definingHopfIdeal_toIdeal_le_ker_of_map_determinant_eq_one
    {H : _root_.CommHopfAlgCat R}
    (f : GeneralLinear.coordinateHopfAlgebra R n ⟶ H)
    (hdet : f.hom (GeneralLinear.determinantGroupLike R n :
      GeneralLinear.coordinateHopfAlgebra R n) = 1) :
    (definingHopfIdeal R n).toIdeal ≤ RingHom.ker f.hom.toAlgHom.toRingHom := by
  rw [definingHopfIdeal_toIdeal, Ideal.span_singleton_le_iff_mem, RingHom.mem_ker, map_sub]
