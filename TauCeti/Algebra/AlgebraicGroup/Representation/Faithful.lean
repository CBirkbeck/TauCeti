...
/-- A matrix-coordinate generator is sent by the coordinate morphism to a matrix coefficient of the
comodule, hence into the algebra those coefficients and their antipode images generate. -/
...
/-- The antipode of a matrix-coordinate generator is sent into the same algebra, landing in its
antipode summand. -/
