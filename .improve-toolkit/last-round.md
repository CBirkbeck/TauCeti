# Last round — r965 (2026-09-23T23:06Z)
...
| **#8413** | `e6125f186` | green (23:04:37Z) | kind 2 (`KnotTheory/Grid/Unknot/Basic.lean`: 62 `↦`; `Roadmap: CombinatorialHeegaardFloer`). Astra accepted it; **marked ready 23:04:55Z** | **external reviewers** |
...
**In progress (cap full): #8413 (ready 23:04:55Z) and the drafts #8426 and #8469 (both astra ✓, builds queued).** #8402 is
...
:03/:13/…/:53); it is session-only and expires 2026-09-30. **Handover:** `fork handover/improve-toolkit` tip is `6e402256f`
