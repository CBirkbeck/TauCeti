...
|---|---|---|---|---|
| **#8525** | `8ae84de0c` | green (08:19:15Z) | kind 2 (`KnotTheory/Grid/Grading/Parity.lean`: 47 `↦`, the roadmap sentence dropped; `Roadmap: CombinatorialHeegaardFloer`). Round 1 (07:17Z): `documentation` asked to move the dated provenance sentence to the PR body (done at `e5b5676d1`); round 2 (07:54Z): documentation ✅ but **`attribution` asked to keep the credit in the docstring**. **Fix 2 at `8ae84de0c`** (r1018): credit restored as a plain source citation ("The Lean proof is adapted from Tau Ceti split-branch commit `05c2722248`."), no dated wording; body explains | **external reviewers** (re-review; step 4 no earlier than 09:19Z) |
...
**In progress (cap full): #8525 (fix 2 green 08:19Z; awaiting re-review), #8530 (ready 07:52Z; 08:52Z) and #8531 (ready 08:09Z; 09:09Z). No drafts.** **#8526 merged 08:06:09Z** (r1019), the thirty-fourth.
