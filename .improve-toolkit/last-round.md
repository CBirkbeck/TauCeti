# Last round — r849 (2026-09-15T17:28Z)
...
**Open question to Chris (asked after r732, unanswered at r849):** `/cleanup` has not run in full on any staged
...
0. **r843–r849:** the cap rule changed (rotation paragraph above). In progress: #6902 (ready 17:08:59Z; step 4 not before
   18:09Z), #6910 and #6911 (drafts, first builds running at 17:29:53Z). Mark each draft ready once its CI is green, drive a
   board only an hour after `max(CI-green, ready)`, and pass #6911, #6910, #6902, #6899, #6896, #6875, #6854 and #6851
   to `queuepos.py`. When a slot frees: kind 3, then kind 1 if a target exists.
