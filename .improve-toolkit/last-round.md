...
| **#8476** | `1f0198742` | running (since 00:31:28Z) | kind 2 (`Exchangeability/Contractability.lean`: 63 `↦`, two `;` chains split, the "Layer 0 home" docstring clause dropped; gate 12/0/0; `Roadmap: Exchangeability`). **Draft**; **astra cleared it** (r968) | **CI** — mark ready when green |

**In progress (cap full): #8469 (ready 00:15Z; step 4 no earlier than 01:15Z), #8473 (ready 00:34:49Z; step 4 no earlier than 01:35Z) and the draft #8476 (building since 00:31Z; astra ✓).**
...
:03/:13/…/:53); it is session-only and expires 2026-09-30. **Handover:** `fork handover/improve-toolkit` tip is `3c6ca19c6`
...
* r974: #8473 went green (00:34:19Z) and was marked ready; #8476's build started at 00:31Z (waiter armed).
