...
**In progress (cap full): #8473 (ready 00:34:49Z; step 4 no earlier than 01:35Z), #8476 (ready 00:44Z; no earlier than 01:44Z) and #8487 (ready 01:28Z; no earlier than 02:28Z). No drafts.** **#8469 merged 01:20:26Z** (r979), the twenty-first this session.
...
:03/:13/…/:53); it is session-only and expires 2026-09-30. **Handover:** `fork handover/improve-toolkit` tip is `0463c7236`
