# Last round — r973 (2026-09-24T00:25Z)
...
| **#8473** | `f52a3a755` | running (since 00:23:18Z) | kind 2 (`Exchangeability/Arrays/RowCoding.lean`: 65 `↦`, and the roadmap sentence in the module docstring replaced by a scope sentence; gate 12/0/0; `Roadmap: Exchangeability`). **Draft**; **astra cleared it** (r967) | **CI** — mark ready when green |
...
**In progress (cap full): #8469 (ready 00:15Z; step 4 opens no earlier than 01:15Z) and the drafts #8473 (building since 00:23Z) and #8476 (queued); both astra ✓.**
...
:03/:13/…/:53); it is session-only and expires 2026-09-30. **Handover:** `fork handover/improve-toolkit` tip is `aa30db159`
