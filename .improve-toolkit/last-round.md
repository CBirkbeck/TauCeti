# Last round — r958 (2026-09-23T21:55Z)
...
**In progress (cap full): the drafts #8402, #8413 and #8426, all astra-cleared, with builds stuck in the CI backlog (124 queued / 2 running at r955).** #8388 and #8389 are
...
:03/:13/…/:53); it is session-only and expires 2026-09-30. **Handover:** `fork handover/improve-toolkit` tip is `288249ddf`
...
* r955–r958: the backlog is still growing (124 → 138 queued, about 5 running, for about 2 h). Reported to the user as a probable runner-capacity problem. All three drafts are cleared by astra and waiting for builds.
