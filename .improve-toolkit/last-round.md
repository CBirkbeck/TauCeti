# Last round — r951 (2026-09-23T20:52Z)
...
**In progress (2 of 3): the drafts #8402 (astra ✓, build queued) and #8413 (astra and build pending).** #8381, #8388 and #8389 are
...
:03/:13/…/:53); it is session-only and expires 2026-09-30. **Handover:** `fork handover/improve-toolkit` tip is `b5217b22c`
